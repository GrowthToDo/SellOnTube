...
metadata:
  ...
  robots:
    ...
    follow: true
  openGraph:
    url: https://sellontube.com/blog/best-youtube-seo-tools-for-business
    siteName: SellOnTube
    locale: en_US
    type: article
  twitter:
...
![SellonTube YouTube SEO Tool screenshot: buyer-intent diagnosis and metadata fix recommendations for business channels](../../assets/images/blog/tools/screenshots/seo-sellontube.png)
...
![TubeBuddy SEO Studio screenshot: keyword explorer and video scorecard inside YouTube Studio](../../assets/images/blog/tools/screenshots/seo-tubebuddy.png)
...
![vidIQ screenshot: AI-powered video ideas and keyword research interface for YouTube channels](../../assets/images/blog/tools/screenshots/seo-vidiq.png)
...
![RyRob YouTube Keyword Tool screenshot: long-tail keyword suggestions generated from YouTube autocomplete data](../../assets/images/blog/tools/screenshots/seo-ryrob.png)
...
![Semrush Keyword Analytics for YouTube screenshot: search volume, competition scores, and trend data](../../assets/images/blog/tools/screenshots/seo-semrush.png)
...
![Morningfame screenshot: channel analytics and video SEO performance dashboard with peer benchmarking](../../assets/images/blog/tools/screenshots/seo-morningfame.png)
...
<p style="font-size: 0.7rem; font-weight: 700; letter-spacing: 0.1em; text-transform: uppercase; color: #059669; margin: 0 0 1rem 0;">What to Do This Week</p>
