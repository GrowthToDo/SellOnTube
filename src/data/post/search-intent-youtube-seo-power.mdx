...
- [The 4 YouTube search intent types](#the-4-youtube-search-intent-types)
- [The data: YouTube vs blogging in a 12-month B2B test](#the-data-youtube-vs-blogging-in-a-12-month-b2b-test)
- [Where YouTube beats blogging for business](#where-youtube-beats-blogging-for-business)
- [Where blogging still wins](#where-blogging-still-wins)
- [The real cost comparison: producing YouTube vs blog content](#the-real-cost-comparison-producing-youtube-vs-blog-content)
- [How to decide: YouTube, blog, or both for your business](#how-to-decide-youtube-blog-or-both-for-your-business)
- [Why the window is still open for B2B YouTube](#why-the-window-is-still-open-for-b2b-youtube)
