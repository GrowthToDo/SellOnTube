...
author: Sathyanand
title: "Search Intent on YouTube: Rank for Buyer Queries"
excerpt: "YouTube search intent decides if your video gets views or gets leads. Map the 4 intent types to your funnel, then target the ones that convert."
...
metadata:
  ...
  description: "YouTube search intent decides if your video gets views or gets leads. Map the 4 intent types to your funnel, then target the ones that convert."
  openGraph:
