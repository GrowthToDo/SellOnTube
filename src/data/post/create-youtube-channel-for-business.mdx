...
- Every description uses the first 150 characters for a keyword-rich hook and CTA link (this is what shows above "Show more")
- Every video has 4-6 timestamped chapters. Each chapter title is a separate search entry point
- Tags include your primary keyword, 2-3 variations, and your brand name
