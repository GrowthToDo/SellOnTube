...
- [ ] Coverage level is appropriate per `docs/blog/content-depth-framework.md` — pSEO pages target 800-2,200 words. Prioritize uniqueness > length. Kill duplicates; don't publish thin pages.
